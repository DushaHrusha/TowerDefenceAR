    ...
    void Update()
    {
        ...
        if(hasHit)
        {
            ...
            if (PlayerMissionManager.Instance.CarWasPlaced)
            {
                ...
                {
                    GetComponentInChildren<MeshRenderer>().material = GameManagerCar.Instance.GlobalGameSettings.AvailableReticleMaterial;
                    PlaceObject(hit.point);
                }
                else
                {
                    GetComponentInChildren<MeshRenderer>().material = GameManagerCar.Instance.GlobalGameSettings.UnavailableReticleMaterial;
                }
            }
            else
            {
